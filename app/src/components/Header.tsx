    ...
    <header className="sticky top-0 z-50 bg-slate-50 text-slate-900 shadow-sm">
      <div className="relative flex min-h-24 w-full items-center px-8 py-6">
        ...
        <div className="ml-auto flex items-center gap-6">
          <Link
            to="/schedule"
            className="text-base font-normal text-slate-700 transition hover:text-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#8C1515]/30 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-50"
          >
            Schedule
          </Link>
          <Link
