  ...
  return (
    <svg width="20" height="10" viewBox="0 0 20 10" fill="none" {...props}>
      ...
      <path
        ...
        className="fill-slate-200 dark:fill-none"
      />
      <path
    ...
    <TooltipPrimitive.Portal>
      ...
      >
        <TooltipPrimitive.Popup
          ...
          className={cn(
            'z-50 w-fit max-w-xs origin-(--transform-origin) rounded-md bg-slate-100 px-3 py-1.5 text-xs text-slate-700 shadow-md ring-1 ring-slate-200 data-closed:animate-out data-closed:fade-out-0 data-closed:zoom-out-95 data-open:animate-in data-open:fade-in-0 data-open:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=inline-end]:slide-in-from-left-2 data-[side=inline-start]:slide-in-from-right-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 data-[state=delayed-open]:animate-in data-[state=delayed-open]:fade-in-0 data-[state=delayed-open]:zoom-in-95',
            className,
          )}
          {...props}
        >
